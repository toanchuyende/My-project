...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// Phân quyền vào các URI.
		http.authorizeRequests().antMatchers("/register", "/viewProfile", "/editProfile")//
				.access("hasAnyRole('ROLE_ADMIN', 'ROLE_STUDENT','ROLE_PARENT','ROLE_LECTURERS','ROLE_STAFF')");
		http.authorizeRequests().antMatchers("/viewAllUsers")//
